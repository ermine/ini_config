...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6aa17732aa209cc543a31a858f745dd3) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ini_lexer"; "Ini_parser"; "Ini_config"];
                      lib_pack = false;
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tests/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "erm_ini_config"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/ermine/ini_config.git";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "ð‚<,ÞÂ'yÆ\006Uí´ûRü";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
